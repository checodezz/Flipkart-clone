...
const LoginDialog = ({ open, setOpen }) => {
  ...
  return (
    ...
    >
      <div className="flex h-auto w-full max-w-[90vw] lg:max-w-[70vw] flex-col lg:flex-row">
        {/* Image section */}
        <div className="hidden lg:block bg-[#2874f0] bg-[url('https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/login_img_c4a81e.png')] bg-center bg-no-repeat bg-cover w-[40%] h-auto p-[20px]">
        ...
        {/* Form section */}
        <div className="flex flex-col p-[25px] w-full max-w-[350px] lg:max-w-none lg:w-[60%] mx-auto">
          {account.view === "login" ? (
            <>
              <input
