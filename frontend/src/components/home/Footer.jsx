...
// Uncomment this line to include the payment methods image.
  ...
  return (
    <>
      <footer
        ...
        className="mt-1 w-full sm:py-4 sm:px-12 bg-primary-darkBlue text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden"
      >
      ...
      <div
        style={{ backgroundColor: "#172337" }}
        className="px-16 py-6 w-full bg-primary-darkBlue hidden lg:flex justify-between items-center text-sm text-white"
      >
        <a
